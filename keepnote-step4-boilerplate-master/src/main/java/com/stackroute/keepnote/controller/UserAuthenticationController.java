...
public class UserAuthenticationController {
	 ...
	 */
	@PostMapping("/login")
	public ResponseEntity<User> login(@RequestBody User  user, HttpSession session) throws UserNotFoundException{
		 boolean validateUser = service.validateUser(user.getUserId(), user.getUserPassword());
		 if (validateUser) {
